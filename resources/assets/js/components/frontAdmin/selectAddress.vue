            ...
            <el-row :gutter='20' class='address'>
                <el-col :span='5'>
                    <el-form-item prop='province'>
                        <el-select v-model='form.province' placeholder='请输入省' @change='proChange' :disabled="disabled">
                            <el-option
                ...
                <el-col :span='5'>
                    <el-form-item prop='city'>
                        ...
                        <el-select v-model='form.city' placeholder='请输入市' @change='cityChange' :disabled="disabled">
                            <el-option
                                    v-for='item in citys'
                                    :key='item.value'
                                    :value='item.value'>
