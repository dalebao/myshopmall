...
Component.options.__file = "/Users/baoxulong/Documents/Code/GitFiles/myshopmall/resources/assets/js/components/frontAdmin/selectAddress.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-254a2599", Component.options)
  } else {
    hotAPI.reload("data-v-254a2599", Component.options)
  }
})()}
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-loader/node_modules/vue-hot-reload-api").rerender("data-v-254a2599", module.exports)
  }
}
    ...
    scopedSlots: _vm._u([
      ["default", function(scope) {
        return [_c('el-button', {
          ...
          on: {
            "click": function($event) {
              _vm.getKd(scope.$index, _vm.data.data)
            }
          }
        }, [_vm._v("\n                    查看物流\n                ")]), _vm._v(" "), _c('el-button', {
          attrs: {
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  ...
  }, [_vm._v("查看订单")])], 1), _vm._v(" "), _c('Menu-item', {
    attrs: {
      "name": "3"
    }
  }, [_c('Icon', {
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-loader/node_modules/vue-hot-reload-api").rerender("data-v-d6a539e0", module.exports)
  }
}
...
var update = __webpack_require__(134)("7ca6660d", content, false);
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../../../node_modules/.0.26.2@css-loader/index.js!../../../../../node_modules/.10.3.0@vue-loader/lib/style-rewriter.js?id=data-v-254a2599!../../../../../node_modules/.10.3.0@vue-loader/lib/selector.js?type=styles&index=0!./selectAddress.vue", function() {
     var newContent = require("!!../../../../../node_modules/.0.26.2@css-loader/index.js!../../../../../node_modules/.10.3.0@vue-loader/lib/style-rewriter.js?id=data-v-254a2599!../../../../../node_modules/.10.3.0@vue-loader/lib/selector.js?type=styles&index=0!./selectAddress.vue");
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(134)("6eb726e2", content, false);
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__selectAddress_vue__ = __webpack_require__(183);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__selectAddress_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__selectAddress_vue__);
//
//
//
//
...
/* harmony default export */ __webpack_exports__["default"] = {
    components: { SelectAddress: __WEBPACK_IMPORTED_MODULE_0__selectAddress_vue___default.a },
    data: function data() {
        return {
            form: {
                nickname: '',
    ...
    created: function created() {
        ...
        axios.get('/api/user/user_info').then(function (res) {
            _this2.form.nickname = res.data.nickname;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_element_ui_lib_theme_default_index_css__ = __webpack_require__(38);
...
/* harmony default export */ __webpack_exports__["default"] = {
    methods: {
        getKd: function getKd(index, rows) {
            var _this = this;

            axios.get('/api/front/getKd/' + this.data.data[index].order_id).then(function (res) {
                if (res.data.Success == false) {
                    ...
                    _this.gridData = res.data.Traces;
                }
            });
        },
        deleteRow: function deleteRow(index, rows) {
            ...
            this.$confirm('此操作将永久删除该订单, 是否继续?', '提示', {
                ...
                axios.delete('/api/user/new_order/' + _this2.data.data[index].order_id).then(function (res) {
                    _this2.$notify({
                        title: '移除成功',
                        message: '订单移除成功',
                        type: 'success'
...
Component.options.__file = "/Users/baoxulong/Documents/Code/GitFiles/myshopmall/resources/assets/js/components/frontAdmin/admin.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-d6a539e0", Component.options)
  } else {
    hotAPI.reload("data-v-d6a539e0", Component.options)
  }
})()}
